...
public class RestAPIProduct {
    ...
    public Set<Product> listProducts(@PathVariable String filterType, @PathVariable String filter) {
        switch (filterType) {
            case "section":
            ...
            default:
            return productService.getProductByFilterColor(Boolean.getBoolean(filter));
        }
    }
}
