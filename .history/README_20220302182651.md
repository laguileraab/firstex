...
The goal of this project is to manage an inventory of products in a warehouse, for that i build an API that allow to consume from a third party app.

## :white_check_mark: Requirements ##

You need to have Java >= 17 and maven installed in order to run this project. Check if you have install it and setting things already with:
...
- [Spring](https://nodejs.org/en/)
- [H2](https://pt-br.reactjs.org/)
